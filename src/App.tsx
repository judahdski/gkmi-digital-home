...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#FAF8F5] text-[#1C1917] selection:bg-[#EAE2D8]">
      ...
      >
        {language === 'id' ? 'Loncat ke konten utama' : 'Skip to main content'}
      </a>
      ...
      <Modal
        ...
        title={language === 'id' ? 'Rencanakan Kunjungan Anda' : 'Plan Your Visit'}
      >
        <PlanVisitForm
          language={language}
          onSuccess={() => {
            ...
            addToast(
              language === 'id' ? 'Kunjungan Terkonfirmasi' : 'Visit Confirmed',
              language === 'id'
