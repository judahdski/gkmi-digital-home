    ...
    const careAreas = [
        {
            title:
                language === "id"
                    ? "Pendampingan Duka & Kehilangan"
                    : "Grief & Loss Accompaniment",
            desc:
                language === "id"
                    ? "Melewati masa kehilangan orang terkasih dengan kehadiran yang menopang tanpa menghakimi air mata."
                    : "Navigating the quiet ache of losing a loved one with steady presence and compassion.",
        },
        {
            title:
                language === "id"
            ...
            desc:
                language === "id"
                    ? "Membangun komunikasi yang sehat, rekonsiliasi, dan fondasi kasih yang kokoh dalam rumah tangga."
                    : "Restoring communication, gentle reconciliation, and enduring foundations at home.",
        },
        {
            title:
                language === "id"
                    ? "Kecemasan & Pergumulan Pribadi"
                    : "Personal Struggles & Anxiety",
            desc:
                language === "id"
                    ? "Mendengarkan beban batin, keraguan iman, dan kelelahan mental dalam ruang yang aman."
                    : "Holding space for unspoken burdens, faith questions, and emotional exhaustion.",
        },
        {
            title:
                language === "id"
                    ? "Doa Pelepasan & Pemulihan"
                    : "Prayer & Spiritual Renewal",
            desc:
                language === "id"
                    ? "Memohon pemulihan rohani dan kekuatan baru dalam hadirat Allah yang berbelas kasih."
                    : "Seeking restorative grace and spiritual clarity in God’s comforting presence.",
        },
        {
            title:
                language === "id"
            ...
            desc:
                language === "id"
                    ? "Mendampingi pasangan mempersiapkan pernikahan dan membangun kehidupan rumah tangga yang berakar dalam iman dan kasih."
                    : "Supporting couples as they prepare for marriage and build a home rooted in faith and love.",
        },
    ];
            ...
            <section className="pt-8 sm:pt-14 border-b border-[#E8E2D8] pb-12">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-4">
                    <div className="text-xs uppercase tracking-widest text-[#A34828] font-semibold">
                        {language === "id"
                            ? "Pelayanan Pastoral GKMI"
                            : "Pastoral Care Gateway"}
                    </div>
                        ...
                        <div className="space-y-5">
                            ...
                            <ul className="space-y-2.5 text-xs sm:text-sm text-stone-600 pt-2">
                                <li className="flex items-center gap-2">
                                    ...
                                    <span>
                                        {language === "id"
                                            ? "Boleh anonim tanpa mencantumkan nama"
                                ...
                                <li className="flex items-center gap-2">
                                    ...
                                    <span>
                                        {language === "id"
                                            ? "Didoakan setia oleh tim pendoa syafaat"
                                            : "Faithfully lifted by pastoral team"}
                                    </span>
                                </li>
                                <li className="flex items-center gap-2">
                                    <span className="w-1.5 h-1.5 rounded-full bg-[#A34828]" />
                                    <span>
                                        {language === "id"
                                            ? "Pilihan untuk dihubungi kembali atau tidak"
                                            : "Option for follow-up or quiet prayer"}
                                    </span>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="space-y-5">
                            ...
                            <ul className="space-y-2.5 text-xs sm:text-sm text-stone-600 pt-2">
                                <li className="flex items-center gap-2">
                                    ...
                                    <span>
                                        {language === "id"
                                            ? "Percakapan tertutup & rahasia penggembalaan"
                                            : "Strict pastoral confidentiality"}
                                    </span>
                                </li>
                                <li className="flex items-center gap-2">
                                    <span className="w-1.5 h-1.5 rounded-full bg-[#1C1917]" />
                                    <span>
                                        {language === "id"
                                            ? "Pilihan tatap muka di gereja atau via WhatsApp"
                                            : "In-person, phone, or WhatsApp options"}
                                    </span>
                                </li>
                                <li className="flex items-center gap-2">
                                    <span className="w-1.5 h-1.5 rounded-full bg-[#1C1917]" />
                                    <span>
                                        {language === "id"
                                            ? "Bimbingan yang penuh empati dan firman"
                                            : "Empathetic, scriptural guidance"}
                                    </span>
                                </li>
                            </ul>
                        </div>
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center max-w-2xl mx-auto mb-12 space-y-3">
                    <h2 className="text-3xl font-serif text-[#1C1917] font-semibold">
                        {language === "id"
                            ? "Ruang Lingkup Pendampingan Kami"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {careAreas.map((area, idx) => (
                        <div
                            key={idx}
                            className={`p-6 sm:p-8 bg-[#FAF8F5] border border-[#E8E2D8] rounded-2xl space-y-2 ${idx === careAreas.length - 1 ? "md:col-span-2" : ""}`}
                        >
                ...
                <div className="bg-[#FAF8F5] border border-[#E8E2D8] rounded-2xl p-8 sm:p-10 flex flex-col sm:flex-row items-start gap-6">
                    ...
                    <div className="space-y-2">
                        <h3 className="text-xl font-serif font-semibold text-[#1C1917]">
                            {language === "id"
                                ? "Komitmen Etika & Kerahasiaan Pastoral"
