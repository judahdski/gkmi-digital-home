...
export const HomePage: React.FC<HomePageProps> = ({
  ...
  const devotions = ARTICLES_DATA.filter(a => !a.isExploringFaith).slice(0, 3);
  const exploringQuestions = ARTICLES_DATA.filter(a => a.isExploringFaith).slice(0, 4);
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 sm:space-y-8">
              <div className="space-y-4">
                ...
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-serif text-[#1C1917] font-semibold tracking-tight leading-[1.12] text-balance">
                  {t.hero.headline}
                </h1>
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3.5 pt-2">
                <button
                  ...
                  className="px-7 py-3.5 bg-[#1C1917] hover:bg-stone-800 text-white font-medium text-sm rounded-lg transition-colors shadow-xs flex items-center justify-center gap-2"
                >
                ...
                <button
                  ...
                  className="px-7 py-3.5 bg-white hover:bg-[#F3EFEA] text-[#1C1917] border border-[#E8E2D8] font-medium text-sm rounded-lg transition-colors flex items-center justify-center"
                >
                  {t.hero.secondaryCta}
                </button>
              </div>

              {/* Quiet Micro Credential / Atmosphere */}
            ...
            {/* Right Column: High-Fidelity Editorial Hero Imagery */}
            <div className="lg:col-span-5 relative">
              <div className="relative rounded-2xl overflow-hidden shadow-lg border border-[#E8E2D8] aspect-16/9 lg:aspect-4/3 bg-[#EAE2D8]">
                <img
                ...
                <div className="absolute bottom-4 left-4 right-4 text-white text-xs sm:text-sm">
                  <p className="font-serif italic drop-shadow-xs">
                    «{language === 'id' ? 'Sebuah rumah bagi jiwa yang mencari kedamaian.' : 'A peaceful sanctuary for seeking hearts.'}»
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-1">
              ...
              <div className="flex flex-wrap items-center gap-3 sm:gap-6 text-sm text-stone-600 pt-1">
                <span className="flex items-center gap-2">
                  ...
                  <span className="font-mono">{church.placeholders.serviceTime}</span>
                </span>
                <span aria-hidden="true" className="text-stone-300">·</span>
                <span className="flex items-center gap-2">
                  <MapPin className="w-4 h-4 text-stone-400" />
                  <span className="font-mono">{church.placeholders.address}</span>
                </span>
              </div>
            </div>
        ...
        <div className="bg-[#FAF8F5] border border-[#E8E2D8] rounded-2xl p-6 sm:p-10 shadow-xs">
          ...
          <div className="mt-8 pt-6 border-t border-[#E8E2D8] flex flex-col sm:flex-row items-center justify-between gap-4">
            <span className="text-xs sm:text-sm text-stone-500">
              {language === 'id' ? 'Masih ada pertanyaan yang belum terjawab?' : 'Have other questions on your mind?'}
            </span>
            <button
              onClick={onOpenPlanVisit}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 items-center">
            ...
            <div className="lg:col-span-5 h-72 sm:h-96 lg:h-full relative bg-[#EAE2D8]">
              <img
                ...
                alt="Potret Gembala Jemaat GKMI"
                ...
                <div className="p-6 space-y-3">
                  ...
                  <div className="flex items-center gap-2 text-xs text-stone-500">
                    <span className="font-medium text-[#A34828]">
                      {t.growInFaith.categories[art.category]}
                    </span>
                    <span aria-hidden="true">·</span>
                    {art.scriptureRef && (
                      <>
        ...
        <div className="bg-[#F3EFEA] border border-[#E8E2D8] rounded-2xl p-8 sm:p-12">
          ...
          <div className="mt-8 pt-6 border-t border-[#E8E2D8] flex items-center justify-between">
            <span className="text-xs text-stone-500">
              {language === 'id' ? 'Pelajari dasar iman Kristen tanpa tekanan' : 'Explore the foundations of faith without pressure'}
            </span>
            <button
              onClick={() => onNavigate('resources')}
            ...
            >
              ...
              <div className="mt-6 pt-4 border-t border-[#E8E2D8] space-y-2 text-xs text-stone-500">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-mono">{evt.timePlaceholder}</span>
                </div>
                <div className="flex items-center gap-2">
                  <MapPin className="w-3.5 h-3.5" />
                  <span className="font-mono">{evt.locationPlaceholder}</span>
                </div>
              </div>
            </div>
          ))}
