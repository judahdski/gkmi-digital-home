                        ...
                        <div className="space-y-3 text-sm text-stone-400">
                            ...
                            <div>
                                ...
                                <span className="text-stone-300">
                                    {placeholders.serviceDay},{" "}
                                    <span className="font-mono text-xs">
                                        {placeholders.serviceTime}
                                    </span>
                                </span>
                            </div>
                            <div>
